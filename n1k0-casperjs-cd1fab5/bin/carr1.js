...
casper.then(function(){fs.write('C:\PowerUp\PPC LinkChecker\4\Test_Data_Automation\ter4.txt','False','w');});
...
casper.then(function() {
 ...
 { 
   email: 'Lance186Marvin@mailinator.com' 
  }, false); 
 });
...
console.log("Check email part");
 this.fill('form[id="PPCRegistrationForm"]', 
{ 
   checkEmail: 'Lance186Marvin@mailinator.com' 
  }, false);
 });
casper.then(function() {
...
casper.then(function(){fs.write('C:\PowerUp\PPC LinkChecker\4\Test_Data_Automation\ter4.txt','true','w');});
...
if(link.indexOf('my-account')!=-1){fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter4.txt','true','w');}else{}
});
casper.run();
