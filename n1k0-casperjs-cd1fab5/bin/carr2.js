...
casper.then(function(){fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter5.txt','false','w');});
...
casper.then(function() {
 ...
 { 
   email: 'Barbara350Dewayne@mailinator.com' 
  }, false); 
 });
...
console.log("Check email part");
 this.fill('form[id="PPCRegistrationForm"]', 
{ 
   checkEmail: 'Barbara350Dewayne@mailinator.com' 
  }, false);
 });
casper.then(function() {
...
this.sendKeys('input#employerOrganizationGroup', 'U', {keepFocus: true});
});casper.then(function() {
...
if (this.visible('a[text()=SOCIAL SECURITY ADMINISTRATION]')) {
this.click('a[text()=SOCIAL SECURITY ADMINISTRATION]');
} else {
...
fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter5.txt','true','w');
...
if(link.indexOf('my-account')!=-1){fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter5.txt','true','w');}else{fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter4.txt','false','w');}
});
casper.run();
