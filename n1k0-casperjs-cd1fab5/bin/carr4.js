...
casper.then(function(){fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter7.txt','false','w');});
...
casper.then(function() {
 ...
 { 
   email: 'Albert121Doug@mailinator.com' 
  }, false); 
 });
...
console.log("Check email part");
 this.fill('form[id="PPCRegistrationForm"]', 
{ 
   checkEmail: 'Albert121Doug@mailinator.com' 
  }, false);
 });
casper.then(function() {
...
if (this.visible('a[text()=MEDSTAR]')) {
this.click('a[text()=MEDSTAR]');
} else {
...
fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter7.txt','true','w');
...
if(link.indexOf('my-account')!=-1){fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter7.txt','true','w');}else{fs.write('C:/PowerUp/PPC LinkChecker/4/Test_Data_Automation/ter7.txt','false','w');}
});
casper.run();
